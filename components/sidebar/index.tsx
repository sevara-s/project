...
export const sidebar: sidebarMenuType[] = [
  {
    id: 1,
    title: "Asosiy",
    path: "/",
...
const Sidebar = () => {
  ...
  return (
    <div
      className={cn(
        "w-[280px] h-screen p-4 border-r flex flex-col gap-[10px] sticky",
    ...
    >
      ...
      <div className="flex flex-col gap-[10px]">
        ...
        {sidebar.map(({ Icon, title, id, path }) => (
          <Button
        ...
        {menu.map(({ Icon, title, id, path }) => (
          <Button
            ...
            className={cn(
              ...
              pathname === path && "bg-secondary text-secondary-foreground"
            )}
            variant="ghost"
          >
            <Icon className="h-4 w-4" />
